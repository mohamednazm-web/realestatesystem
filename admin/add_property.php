...
$file=$_FILES['file']['name'];
  ...
  $query="insert into property values('','$title','$bedroom','$hall','$kitchan','$bathroom','$balcony','$price','$sqr_price','$add','$video','$file','$description','$location','$property_owner', '$property_owner_number','$property_type','$lot_size','$sold','$land_area',now())";  
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row clearfix">
                                   ...
                                   <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="number" name="property_owner_number" class="form-control">
