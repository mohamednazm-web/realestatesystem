...
if(isset($submit))
{
  ...
  $query="update property set title='$title',bedroom='$bedroom',hall='$hall',kichan='$kichan',price='$price',sqr_price='$sqr_price',address='$add',description='$description',video='$video',location='$location',bathroom='$bathroom',balcony='$balcony',property_owner='$property_owner', property_owner_number='$property_owner_number',property_type='$property_type',lot_size='$lot_size',land_area='$land_area',sold='$sold' where id='$id'";
  ...
  $query="update property set title='$title',bedroom='$bedroom',hall='$hall',kichan='$kichan',price='$price',sqr_price='$sqr_price',address='$add',description='$description',video='$video',location='$location',bathroom='$bathroom',balcony='$balcony',property_owner='$property_owner',, property_owner_number='$property_owner_number',property_type='$property_type',lot_size='$lot_size',land_area='$land_area',sold='$sold',image='$file' where id='$id'";
  mysqli_query($con,$query);
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row clearfix">
                                  ...
                                  <div class="col-lg-6 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input required type="text" name="property_owner_number" value="<?php echo $res['property_owner_number'];?>" class="form-control">
                                                <label class="form-label">Property Owner Phone Number</label>
                                            </div>
                                        </div>
                                    </div>
